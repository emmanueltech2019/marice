...
const Overview = (props: Props) => {
  ...
  return (
    <GlobalContainer className='grid md:grid-cols-2 gap-10 py-40'>
        <BigCard notImage noBorder='border-none' padding titleText='OVERVIEW' title='How we serve best food on time to you in town.' fontSize='text-5xl' buttonText='Start Free Trial' description='Lorem Ipsum is simply dummy text of the printing and typtting industry lorem Ipsum has been the industrys standard dummy text ever since.' lists={overviewListArray} />
